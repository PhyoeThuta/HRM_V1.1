...
export default function SopReportTab({ positions }) {
  ...
  return (
    <div className="space-y-8">
      {/* Filters */}
      <div className="flex flex-wrap gap-4 items-end bg-[rgb(var(--color-surface-800))] p-4 rounded-xl border border-slate-700">
        <div>
      ...
      {isLoading ? (
        ...
        <>
          ...
          <div>
            ...
            <div className="bg-[rgb(var(--color-surface-800))] rounded-xl overflow-hidden border border-slate-700 overflow-x-auto">
                  ...
                  {activeEmployees.length === 0 ? (
                    ...
                    return (
                      <tr key={emp.id} className="hover:bg-slate-800/30 transition-colors">
                        <td className="p-3 font-medium sticky left-0 bg-[rgb(var(--color-surface-800))] z-10 border-r border-slate-700 shadow-[2px_0_5px_-2px_rgba(0,0,0,0.5)]">
                          {emp.Full_name}
                        </td>
          ...
          <div>
            ...
            <div className="space-y-4">
              {monthlySummary.map(({ emp, totalCount, completedCount, missedCount, missedDays }) => {
                ...
                return (
                  <div key={emp.id} className={`bg-[rgb(var(--color-surface-800))] rounded-xl border ${totalCount === 0 ? 'border-slate-700/50 opacity-70' : 'border-slate-700'} overflow-hidden`}>
                    {/* Header */}
                    ...
                    {/* Progress bar */}
                    <div className="px-4 py-2 bg-[rgb(var(--color-surface-850))]/50">
              ...
              {monthlySummary.length === 0 && (
                 <div className="p-10 text-center text-slate-500 border border-dashed border-slate-700 rounded-xl bg-[rgb(var(--color-surface-800))]">
      ...
      {missedModal && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4" onClick={() => setMissedModal(null)}>
          <div className="bg-[rgb(var(--color-surface-800))] w-full max-w-md rounded-2xl shadow-2xl border border-rose-500/30 overflow-hidden" onClick={e => e.stopPropagation()}>
            {/* Modal header */}
