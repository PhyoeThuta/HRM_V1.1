  ...
  return (
    <div className="p-4 space-y-8">
      ...
      <section>
        ...
        <div className="bg-[rgb(var(--color-surface-800))] rounded-xl overflow-hidden border border-slate-700">
      ...
      {showRosterModal && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-[rgb(var(--color-surface-800))] w-full max-w-md rounded-2xl shadow-2xl overflow-hidden border border-slate-700">
            <div className="p-6">
