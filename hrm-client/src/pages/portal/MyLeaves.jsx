  ...
  return (
    <Layout title="My Leaves" subtitle="View your leave balances and submit requests to HR">
      ...
      <div className="flex gap-4 mb-6 overflow-x-auto pb-2 scrollbar-thin scrollbar-thumb-white/10 scrollbar-track-transparent">
        {isLoading ? (
          ...
          balances.map(b => {
            ...
            return (
              <div key={b.id} className="min-w-[280px] flex-1 rounded-2xl p-5 flex flex-col justify-between" style={{ background: 'rgb(var(--color-surface-800))', border: '1px solid rgba(255,255,255,0.05)' }}>
                <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
        ...
        <div className="rounded-2xl p-5 h-full min-h-[400px] flex flex-col" style={{ background: 'rgb(var(--color-surface-800))', border: '1px solid rgba(255,255,255,0.05)' }}>
