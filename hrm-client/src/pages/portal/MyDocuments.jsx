    ...
    <Layout title="My Documents" subtitle="Company policies and your personal files">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {isLoading ? (
          ...
          documents.map(d => (
            <div key={d.id} className="rounded-2xl p-6 relative group overflow-hidden" style={{ background: 'rgb(var(--color-surface-850))', border: '1px solid rgba(255,255,255,0.05)' }}>
              {/* Type Badge */}
          ...
          <div className="col-span-full rounded-2xl p-16 text-center" style={{ background: 'rgb(var(--color-surface-850))', border: '1px solid rgba(255,255,255,0.05)' }}>
