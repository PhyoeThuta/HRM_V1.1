...
export default function CameraCheckin() {
  ...
  return (
    <Layout title="Photo Check-In 📸" subtitle="Take a selfie to record your attendance">
      <div className="max-w-2xl mx-auto rounded-2xl overflow-hidden shadow-2xl" style={{ background: 'rgb(var(--color-surface-850))', border: '1px solid rgba(255,255,255,0.05)' }}>
          ...
          {!isCameraStarted ? (
            ...
            <>
              ...
              <div className="absolute inset-0 bg-emerald-500/20 flex items-center justify-center backdrop-blur-sm">
                <div className="bg-[rgb(var(--color-surface-850))] px-6 py-4 rounded-2xl border border-white/10 text-center shadow-xl">
        ...
        {/* Info Panel */}
        <div className="p-6 bg-[rgb(var(--color-surface-800))]">
