    ...
    <Layout title="Positions" subtitle="Manage job titles and seniority levels">
      ...
      <div className="space-y-8">
        {isLoading ? (
          ...
          <div key={p.id} className="p-6 rounded-2xl border border-white/5 bg-[rgb(var(--color-surface-800))] hover:bg-white/5 transition-colors flex flex-col h-full">
      ...
      {deleteTarget && (
        <div className="fixed inset-0 z-[60] flex items-center justify-center">
          ...
          <div className="relative bg-[rgb(var(--color-surface-800))] border border-rose-500/30 rounded-2xl w-full max-w-sm m-4 p-6 shadow-2xl shadow-rose-900/20 text-center">
