      ...
      <div className="space-y-2 max-h-64 overflow-y-auto">
        {all.slice(0, 12).map(h => (
          <button
            ...
            className="w-full text-left p-3 rounded-xl border border-white/5 bg-[rgb(var(--color-surface-850))] hover:bg-white/5 transition-colors"
          >
    ...
    <Layout title={`Profile: ${emp.Full_name}`} subtitle={`Employee ID: ${emp.employee_id}`}>
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-6">
          <div className="p-6 rounded-2xl border border-white/5 bg-[rgb(var(--color-surface-800))]">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="p-6 rounded-2xl border border-white/5 bg-[rgb(var(--color-surface-800))]">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {leave_balances?.map(lb => (
                <div key={lb.id} className="p-4 rounded-xl border border-white/5 bg-[rgb(var(--color-surface-850))]">
          ...
          <div className="p-6 rounded-2xl border border-white/5 bg-[rgb(var(--color-surface-800))]">
            ...
            <div className="space-y-3">
              {kpi_records?.map(k => (
                <div key={k.id} className="p-4 rounded-xl border border-white/5 bg-[rgb(var(--color-surface-850))] flex justify-between items-center">
                  <div>
