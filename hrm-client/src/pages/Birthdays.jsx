  ...
  return (
    <Layout title="Upcoming Birthdays" subtitle="Celebrate with your colleagues">
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-5">
        ...
        : birthdays.map((b, i) => (
          <div key={i} className="rounded-2xl p-5 text-center relative overflow-hidden group" style={{ background: 'rgb(var(--color-surface-800))', border: '1px solid rgba(255,255,255,0.05)' }}>
