  ...
  return (
    <Layout title="Payroll & KPI Management" subtitle="Track salary processing, payments, and performance scores">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mb-6">
        <div className="rounded-2xl p-5 bg-surface-800 border border-emerald-500/20">
      ...
      <div className="rounded-2xl overflow-hidden mb-6 bg-surface-800 border border-white/5">
      ...
      {showModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative rounded-2xl w-full max-w-xl p-6 max-h-[90vh] overflow-y-auto bg-surface-850 border border-white/10">
