    ...
    <Layout title="Executive Overview" subtitle="High-level insights for top management">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 mb-6">
        {[
          ...
          <div key={s.label} className="rounded-2xl p-5" style={{ background: 'var(--bg-800, #1e2235)', border: `1px solid rgba(var(--color-${s.color}-500, 255,255,255), 0.1)` }}>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
        <div className="rounded-2xl p-6 flex flex-col items-center justify-center text-center" style={{ background: 'var(--bg-800, #1e2235)', border: '1px solid rgba(255,255,255,0.05)', minHeight: '300px' }}>
        ...
        <div className="rounded-2xl p-6" style={{ background: 'var(--bg-800, #1e2235)', border: '1px solid rgba(255,255,255,0.05)', minHeight: '300px' }}>
