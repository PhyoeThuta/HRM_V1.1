...
function ExitInterviewPage({ ob, onClose }) {
  ...
  const RatingRow = ({ title, desc, field }) => (
    <div className="rounded-2xl p-6 mb-6" style={{ background: 'rgb(var(--color-surface-800))', border: '1px solid rgba(255,255,255,0.05)' }}>
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6 pb-20">
      ...
      {/* Interview Details */}
      <div className="rounded-2xl p-6" style={{ background: 'rgb(var(--color-surface-800))', border: '1px solid rgba(255,255,255,0.05)' }}>
        ...
        <div className="grid grid-cols-2 gap-5 mb-5">
          <div>
            ...
            <input
              ...
              className="w-full bg-[rgb(var(--color-surface-850))] border border-white/10 rounded-xl px-4 py-3 text-sm text-white outline-none focus:border-indigo-500 transition-colors"
            />
          </div>
          <div>
            ...
            <input
              ...
              className="w-full bg-[rgb(var(--color-surface-850))] border border-white/10 rounded-xl px-4 py-3 text-sm text-slate-300 outline-none focus:border-indigo-500 transition-colors"
            />
          </div>
        </div>
        <div>
          ...
          <textarea
            ...
            rows={3}
            className="w-full bg-[rgb(var(--color-surface-850))] border border-white/10 rounded-xl px-4 py-3 text-sm text-white outline-none focus:border-indigo-500 resize-none transition-colors"
          />
        </div>
      </div>
...
function OffboardingDetail({ obId, onBack, onShowEI }) {
  ...
  return (
    <div className="space-y-5">
      ...
      {/* Tabs */}
      <div className="flex gap-1 p-1 rounded-xl" style={{ background: 'rgb(var(--color-surface-800))' }}>
        {[
    ...
    <Layout title="Offboarding & Exit Management" subtitle="Asset clearance, task tracking, and exit interviews">
      ...
      <div className="grid grid-cols-3 gap-4 mb-8">
        {[
          ...
          <div key={label} className="rounded-2xl p-6 text-center" style={{ background: 'rgb(var(--color-surface-800))', border: '1px solid rgba(255,255,255,0.05)' }}>
      ...
      {/* Initiate form */}
      <div className="rounded-2xl p-6 mb-8" style={{ background: 'rgb(var(--color-surface-800))', border: '1px solid rgba(255,255,255,0.05)' }}>
      ...
      <div className="space-y-4">
        {isLoading ? (
          ...
          <div className="py-12 text-center rounded-2xl border border-dashed border-slate-700 text-slate-500 text-sm" style={{ background: 'rgb(var(--color-surface-800))' }}>
          ...
          return (
            <div key={o.id} className="rounded-2xl overflow-hidden" style={{ background: 'rgb(var(--color-surface-800))', border: '1px solid rgba(255,255,255,0.05)' }}>
              {/* Card header */}
